---
arm: 3y_baseline
data: data/scenarios/3y_baseline/visible/
catalog_extra: SKUs.xlsx
horizon: 2025-01-01 .. 2027-12-31
instructor: BUSINESS_CASE_INSTRUCTOR.md
---

# Malm's Market — Engagement Brief
...
accompanying this brief lives at `data/scenarios/3y_baseline/visible/`
(plus the product catalog, `SKUs.xlsx`).*
