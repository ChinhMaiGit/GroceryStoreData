...
## Roadmap
  ...
  6. **Analysis notebooks (in progress):** the three-year arc is covered (`three_year_review`, `competitor_entry_study`, `expansion_review`); remaining: one notebook per analytics layer of the catalog at full depth, plus the one-year workbook's retrofit to the three-year arm.
