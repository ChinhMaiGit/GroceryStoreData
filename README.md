...
## Roadmap
  ...
  6. **Analysis notebooks (next):** one per analytics layer, validated against the hidden ground truth; plus the workbook's retrofit to the three-year arm (a year dimension everywhere).
