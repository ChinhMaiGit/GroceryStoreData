...
intended as a self-contained companion for anyone who wants to
understand this simulated economy in its own right: every mechanism
described here is described completely, in the same narrative register
throughout, rather than deferred to outside reference material.
\end{abstract}
...
merely argued about. This paper's job was only ever to explain why each
of those mechanisms is there, and what it is like to live inside the
economy they add up to.
